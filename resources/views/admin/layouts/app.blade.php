@inject('leftMenuPresenter','App\Presenters\Admin\Menu')
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="navbar navbar-default" id="navbar">
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="{{action('Admin\IndexController@index')}}" class="navbar-brand">
                <small>
                    <i class="icon-leaf"></i>
                    后台管理系统
                </small>
            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="{{asset('admin/avatars/user.jpg')}}" alt="{{$admin_info['username']}}'s Photo" />
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="{{action('Admin\LoginController@logout')}}">
                                <i class="icon-off"></i>
                                Logout
                            </a>
                        </li>
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                {!! $leftMenuPresenter->showLeftMenu() !!}
